...
namespace EcoWatt.Repository
{
    public class Repository<T> : IRepository<T> where T : class
    {
        ...
        public async Task Add(T entity, int choice)
        {
            if (choice == 0)
            {
                var sqlCommand = "BEGIN inserir_ecowatt_usuario(:param1, :param2, :param3, :param4, :outputIdParam); END;";
                ...
                await _context.Database.ExecuteSqlRawAsync(sqlCommand, param1, param2, param3, param4, outputIdParam);
            ...
            {
                var sqlCommand = "BEGIN inserir_ecowatt_baterias(:param1, :param2, :param3, :param4, :param5, :param6, :param7, :outputIdParam); END;";
                ...
                var param7 = new OracleParameter("param7", OracleDbType.Date) { Value = dtCriacaoValor };
                ...
                await _context.Database.ExecuteSqlRawAsync(sqlCommand, param1, param2, param3, param4, param5, param6, param7, outputIdParam);
